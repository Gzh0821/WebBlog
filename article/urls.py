...
urlpatterns = [
    ...
    path('article-collect/<int:article_id>/', views.article_collect, name='article_collect'),
    path('article-cancel-collect/<int:article_id>/', views.article_cancel_collect, name='article_cancel_collect'),
